...
public class SupportPublicProjectInDefaultPermissionTemplateTest {
  ...
  @Rule
  public CoreDbTester db = CoreDbTester.createForSchema(SupportPublicProjectInDefaultPermissionTemplateTest.class, "organizations_and_groups_and_permission_templates.sql");
  @Rule
  public ExpectedException expectedException = ExpectedException.none();

  private SupportPublicProjectInDefaultPermissionTemplate underTest = new SupportPublicProjectInDefaultPermissionTemplate(db.database(), new DefaultOrganizationUuidImpl());
