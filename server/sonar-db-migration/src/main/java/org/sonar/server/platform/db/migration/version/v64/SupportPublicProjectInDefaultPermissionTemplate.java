...
public class SupportPublicProjectInDefaultPermissionTemplate extends DataChange {
  ...
  public SupportPublicProjectInDefaultPermissionTemplate(Database db, DefaultOrganizationUuid defaultOrganizationUuid) {
    super(db);
  ...
  private void insertGroupPermissionIfNotPresent(Context context, int groupId, int templateId, String permission) throws SQLException {
  ...
  private boolean groupHasPermissionInTemplate(Context context, int templateId, int groupId, String permission) throws SQLException {
  ...
  private void insertGroupPermission(Context context, int templateId, int groupId, String permission) throws SQLException {
    Date now = new Date();
  ...
  private ResolvedOrganizationProperties readOrganizationProperties(Context context, String defaultOrganizationUuid) throws SQLException {
  ...
  @CheckForNull
  private Integer getPermTemplateId(Context context, @Nullable String permissionTemplateUuid) throws SQLException {
