...
public class OrganizationActionTest {
  ...
  public void returns_non_admin_and_canUpdateProjectsVisibilityToPrivate_false_when_user_logged_in_but_not_admin_and_extension_returns_true() {
    ...
    verifyCanUpdateProjectsVisibilityToPrivateResponse(response, false);
  }

  @Test
  public void returns_admin_and_canUpdateProjectsVisibilityToPrivate_true_when_user_logged_in_and_admin_and_extension_returns_true() {
    OrganizationDto defaultOrganization = dbTester.getDefaultOrganization();
    userSession.logIn().addPermission(ADMINISTER, defaultOrganization);
    when(billingValidations.canUpdateProjectsVisibilityToPrivate(any(BillingValidations.Organization.class))).thenReturn(true);
    ...
    verifyCanUpdateProjectsVisibilityToPrivateResponse(response, true);
  }

  @Test
  public void returns_admin_and_canUpdateProjectsVisibilityToPrivate_false_when_user_logged_in_and_admin_and_extension_returns_false() {
    OrganizationDto defaultOrganization = dbTester.getDefaultOrganization();
    userSession.logIn().addPermission(ADMINISTER, defaultOrganization);
